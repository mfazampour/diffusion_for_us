...
# thyroid test set
python semantic_diffusion_model/image_sample.py --datadir /home/data/farid/THYROID_MULTILABEL_2D_3D/imagesTest/2D/ --dataset_mode thyroid --resume_checkpoint output/b-maps/dataset_thyroid-b_map_min_1.0-img_size_128-lr_1e-05-diffusion_steps_4000/2024-02-29/model088000.pt --results_dir output/b-maps/dataset_thyroid-b_map_min_1.0-img_size_128-lr_1e-05-diffusion_steps_4000/2024-02-29/ --num_samples 59 --is_train False --inference_on_train True --img_size 128 --num_channels 128 --batch_size_test 20 --batch_size_train 20 --distributed_data_parallel False --diffusion_steps 400 --b_map_min 1.0 --num_workers 8 --use_ddim True --use_fp16 False
