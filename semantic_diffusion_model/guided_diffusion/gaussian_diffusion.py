...
## ---------------------- ddim we are not using it, it has bugs ------------------------ ##
    def ddim_sample(
            self,
            model,
            x,
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        #print("q_sample applied to x_start: ", x_start.shape)
        ...
        # Determine the maximum number of channels among the three tensors
        max_channels = max(x_start.shape[1], model_kwargs['y'].shape[1], noise.shape[1], x_t.shape[1])
        return terms
